  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {cart.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center px-6">
              ...
              <h4 className={`font-black text-xl mb-2 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Your cart is empty</h4>
        ...
        {cart.length > 0 && (
          <div className={`rounded-t-3xl border-t shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] p-5 shrink-0 z-10 ${isDark ? 'bg-[#1a1535] border-[#2d2450]' : 'bg-white border-orange-100'
            }`}>
            ...
            <div className={`p-4 rounded-2xl mb-4 border space-y-2 ${isDark ? 'bg-[#13102a] border-[#2d2450]' : 'bg-slate-50 border-gray-100'
              ...
              <Row label="Item Total" value={`₹${subtotal}`} isDark={isDark} />
              <Row
                label="Delivery Fee"
              ...
              <div className={`flex justify-between items-center pt-3 mt-1 border-t ${isDark ? 'border-[#2d2450]' : 'border-gray-200/60'}`}>
                <span className={`text-sm font-black ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Grand Total</span>
