...
const ESSENTIALS = [
  ...
  { image: '/products/humpi-handbag.png', name: 'हम्पी हैंडबैग', tag: 'उनके नख़रे और उनका पर्स – दोनों संभालना मुश्किल है!' },
